...
This is the **living backlog** for aws-multi-strands-agents. Tasks move from here to `NEXT-TASKS.md` when they become active in the current sprint.
...
A task moves from FUTURE → NEXT when:
...
## 🗑️ Archive (Rejected / No Longer Relevant)
