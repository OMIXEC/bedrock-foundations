...
st.set_page_config(page_title="UsTickets Support Assistant", page_icon="🎟️")
st.title("UsTickets – AI Tickets Customer Support")
...
if st.session_state.get("intro_shown", True):
    st.markdown(
        """
👋 Welcome to **UsTickets's AI Support Assistant**! 🎟️
