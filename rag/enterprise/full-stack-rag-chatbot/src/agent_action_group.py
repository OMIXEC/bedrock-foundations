...
AVAILABLE_EVENTS = [
    {"event": "Tech Conference", "date": "2025-09-01", "city": "San Francisco"},
    {"event": "Art Expo", "date": "2025-08-23", "city": "Chicago"},
     {"event": "Opera Concert", "date": "2025-07-11", "city": "New York"},
    {"event": "Hip-hop Festival", "date": "2025-07-11", "city": "New York"},
    {"event": "Cinematic Evening", "date": "2025-07-11", "city": "Boston"},
    {"event": "Festifood", "date": "2025-07-11", "city": "New York"},
]
...
EVENT_DETAILS = {
    ...
    "Cinematic Evening": {
        "name": "Cinemtic evening",
        "price": "$20.00",
        "availability": "available",
        "seats_remaining": "few",
        "age_classification": "All ages, 18+",
...
def handle_buy_ticket(params):
    ...
    confirmation_code = (
        f"UsTickets-{event_name.replace(' ', '')}-{hash(email) % 10000:04d}"
    )
